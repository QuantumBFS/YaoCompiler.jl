...
qasm by setting `optimize` to `true`. See [@code_yao](@ref) for detailed configuration on YaoCompiler passes
via `passes` keyword.
...
Return the quantum CodeInfo generated by YaoCompiler compiler for a given
...
- `:zx`: YaoCompiler's ZX calculus based passes
"""
macro code_yao(exs...)
